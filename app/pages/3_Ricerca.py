...
st.caption("Agente Ricercatore — interroga PubMed + Europe PMC, deduplica e porta paper reali. Stadio 1 della pipeline.")
...
if st.button("🔎 Cerca (PubMed + Europe PMC)", type="primary"):
